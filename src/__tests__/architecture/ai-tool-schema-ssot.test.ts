...
const EXPECTED_SCHEMA_BY_TOOL = {
  ...
  site_create_visual_component: CreateVisualComponentInputSchema,
  site_componentize_node: ComponentizeNodeInputSchema,
  site_upsert_component_param: UpsertComponentParamInputSchema,
  site_expose_component_param: ExposeComponentParamInputSchema,
  site_bind_component_param: BindComponentParamInputSchema,
  site_add_component_slot: AddComponentSlotInputSchema,
  site_insert_component_instance: InsertComponentInstanceInputSchema,
  site_set_component_instance_overrides: SetComponentInstanceOverridesInputSchema,
  site_create_explorer_folder: CreateExplorerFolderInputSchema,
  site_move_explorer_item: MoveExplorerItemInputSchema,
